...
const simih = async (text) => {
		const sami = await fetchJson(`https://api.simsimi.net/v2/?text=${encodeURIComponent(body.slice(5))}&lc=pt&cf=false`, {method: 'get'})
...
const banner = cfonts.render(('RISKY|BOT'), {
    font: 'block',
    color: 'red',
    align: 'center',
    gradient: ["red","white"],
